...
\end{equation} where $f$ is an \textit{interaction function} that maps model parameters to the predicted feedback $\hat{r}_{ui}$ and $\Theta$ denotes model parameters to be estimated by a learning algorithm \cite{10.1145/3038912.3052569}.
